...
<head>
  ...
  <title>travaux de terrain - KMD Services</title>
...
<div class="profile"> 
  ...
  <p class="role">Constructeur de regard et tranchée</p>
<p>Realisation de regard, tranchée et canalisations pour réseaux d'eau ou d'electricité.
    travaux rapide, solide et aux normes de sécurité
</p>
...
whatsappBtn.addEventListener('click', function() {
  ...
  const message = encodeURIComponent(summaryText.textContent + "\nC'est pour les travaux de terrain, Merci de confirmer rapidement");
