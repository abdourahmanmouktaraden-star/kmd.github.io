...
<head>
  ...
  <title>Mecanique - KMD Services</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <header>
    <a href="index.php" class="back">← Retour</a>
    <h1>Mecanique - KMD Services</h1>
  </header>

<div class="profile"> 
  <img src="kassim.jpg" alt="Photo de Kassim">
  <h2>Kassim Sayed Mahamoud</h2>
  <p class="role">Technicien mecanicien</p>
<p>Spécialiste en fuites, robinetterie, installation sanitaire.</p>
...
whatsappBtn.addEventListener('click', function() {
  const phone = "25377373801"; // numéro de Kassim
  const message = encodeURIComponent(summaryText.textContent + "\nC'est pour la mecanique, Merci de confirmer rapidement.");
